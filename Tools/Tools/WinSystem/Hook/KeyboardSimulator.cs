...
// Type: System.WinSystem.Hook.KeyboardSimulator
...
namespace System.WinSystem.Hook
{
  public static class KeyboardSimulator
  {
    ...
    {
      KeyboardSimulator.keybd_event(KeyboardSimulator.ParseKey(key), (byte) 0, 0, 0);
    }

    public static void KeyUp(Keys key)
    {
      KeyboardSimulator.keybd_event(KeyboardSimulator.ParseKey(key), (byte) 0, 2, 0);
    }
